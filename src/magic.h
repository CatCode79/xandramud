...
DECLARE_SPELL_FUN( spell_summon_zombie		);
DECLARE_SPELL_FUN( spell_summon_skeleton	);
DECLARE_SPELL_FUN( spell_summon_spectre		);
DECLARE_SPELL_FUN( spell_summon_banshee		);
