...
/* Per le tipologie di comandi */
#define IMP			MAX_LEVEL		/* Implementor	*/
#define CRE			MAX_LEVEL - 1	/* Creatore		*/
#define DEI			MAX_LEVEL - 2	/* Divinita'	*/
#define ADM			LEVEL_ADMIN		/* Immortale	*/
#define AVA			LEVEL_AVATAR	/* Avatar		*/
#define HER			LEVEL_HERO		/* Eroe			*/
...
DECLARE_DO_FUN( do_supplication	);
