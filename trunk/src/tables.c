...
/*********************************************************
 * <longname> <shortname (max 12 char for who)> <cabal item> <cabal shrine> NULL
 */
struct cabal_type cabal_table[] =
{
	...
	{ "the Masters of the Arcane Arts",	 "YVALADRIN",	531, 530, NULL },
	{ "l'Armata degli Elmi d'Argento",	 "ARMATA",		541, 548, NULL },
